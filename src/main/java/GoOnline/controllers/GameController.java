...
public class GameController {
    ...
    @MessageMapping("/game/{chatID}")
    @SendTo("/topic/game/{chatID}")
    public String sendMessage(@DestinationVariable("chatID") int chatID, @Payload String message, Principal principal) {
